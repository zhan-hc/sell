  ...
  <div class="seller" ref="sellerScroll">
    <div class="seller-content">
      <div class="overview">
        ...
        <div class="favorite" @click="toggleFlag">
      ...
      <div class="bulletin">
        ...
        <ul v-if="seller.supports" class="supports">
          <li class="support-item border-1px"  v-for="(item,index) in seller.supports" :key="index">
            <icon :item='item' size='4' wh='16px' mr='6px'></icon>
      ...
      <split></split>
      <div class="info">
        <h1 class="title border-1px">商家</h1>
        <ul>
  ...
  methods: {
    _initPics () {
      if (this.seller.pics) {
        ...
        this.$refs.picList.style.width = width + 'px' // 给ul设置了宽度
        this.$nextTick(() => {
          if (!this.picScroll) {
